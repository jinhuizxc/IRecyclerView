...
public class ClassicRefreshHeaderView extends RelativeLayout implements RefreshTrigger {
    ...
    public ClassicRefreshHeaderView(@NonNull Context context) {
//        super(context);
        this(context, null);
    }

    public ClassicRefreshHeaderView(@NonNull Context context, @Nullable AttributeSet attrs) {
//        super(context, attrs);
